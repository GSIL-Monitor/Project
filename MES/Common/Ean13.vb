...
Public Class Ean13
    ...
    Private _fHeight As Single = 10 '25.93f;
    Private _fFontSize As Single = 7.5F
    ...
    Public Function CreateBitmap() As System.Drawing.Bitmap
        ...
        Dim bmp As New System.Drawing.Bitmap(Convert.ToInt32(tempWidth), Convert.ToInt32(tempHeight))
    ...
    Public Property ChecksumDigit() As String
        ...
        Set(ByVal value As String)
            ...
            If iValue < 0 OrElse iValue > 9 Then
                Throw New Exception("The Check Digit m" & ChrW(6) & "st be between 0 and 9.")
            End If
