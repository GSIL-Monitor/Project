...
#Region "Propertys"
    ...
    Public Overloads Property Text() As String
        ...
        End Get
        Set(ByVal value As String)
            If Me.TextBoxType = Control.TextBoxType.txtDate Then
                If IsDate(value) Then
                    Me.txt.Text = CDate(value).ToString("yyyy-MM-dd")
                Else
                    Me.txt.Text = ""
                End If
            Else
            ...
            If Me.TextBoxType = Control.TextBoxType.txtBigDate Then
                If IsDate(value) Then
                    Me.txt.Text = CDate(value).ToString("yyyy-MM-dd")
                Else
                    Me.txt.Text = ""
    ...
    Public Property TextBoxType() As TextBoxType
        ...
        Set(ByVal value As TextBoxType)
            ...
            If value = Control.TextBoxType.txtDate Then
                Pic.Image = Me.PicDate.Image
            ElseIf value = Control.TextBoxType.txtBigDate Then
                Pic.Image = Me.PicDate.Image
            ElseIf value = Control.TextBoxType.txtDateTime Then
                Pic.Image = Me.PicDate.Image
...
#End Region
    ...
    Private Sub MyTextBox_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Leave
        ...
        If Me.TextBoxType = Control.TextBoxType.txtDate And Me.Text.Trim <> "" Then
            If IsDate(Me.Text) = False Then
                ...
                Exit Sub
            Else
                txt.Text = CDate(txt.Text).ToString("yyyy-MM-dd")
            End If


        End If

        If Me.TextBoxType = Control.TextBoxType.txtDateTime And Me.Text.Trim <> "" Then
            If IsDate(Me.Text) = False Then
                MsgBox("日期格式不正确", MsgBoxStyle.Information, "提示")
                Me.Focus()
                Exit Sub
            Else
                txt.Text = CDate(txt.Text).ToString("yyyy-MM-dd HH:mm:ss")
            End If


        End If

        If Me.TextBoxType = Control.TextBoxType.txtBigDate And Me.Text.Trim <> "" Then
            If IsDate(Me.Text) = False Then
                MsgBox("日期格式不正确", MsgBoxStyle.Information, "提示")
                Me.Focus()
                Exit Sub
    ...
    Private Sub Pic_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Pic.Click
        ...
        ElseIf Me.TextBoxType = Control.TextBoxType.txtBigDate Then

            Dim frm As New frmDateBig
        ...
        ElseIf Me.TextBoxType = Control.TextBoxType.txtDateTime Then
...
#End Region
    ...
    Private Sub txt_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt.KeyDown
        If e.KeyCode = Keys.F2 And Me.TextBoxType = Control.TextBoxType.txtZoom Then
